...
<div class="feature-bar" id="feature-bar">
  ...
  <div class="feature-actions" id="feature-actions">
    ...
    <button class="dash-btn" id="feat-views-btn">&#9635; Saved Views</button>
    <button class="dash-btn" id="feat-admin-btn" style="display:none;">&#9881; Admin</button>
    <button class="dash-btn dash-btn-primary" id="feat-upgrade-btn">&#9650; Upgrade to Pro</button>
    <span class="pro-badge" id="feat-pro-badge" style="display:none;">PRO</span>
  </div>
</div>
...
function featApplyRole() {
  const up = document.getElementById("feat-upgrade-btn");
  const badge = document.getElementById("feat-pro-badge");
  const admin = document.getElementById("feat-admin-btn");
  if (up) up.style.display = featMe.isPro ? "none" : "";
  if (badge) badge.style.display = featMe.isPro ? "" : "none";
  if (admin) admin.style.display = featMe.isAdmin ? "" : "none";
}
...
function initFeatures() {
  featInitPresets();
  const on = (id, fn) => { const el = document.getElementById(id); if (el) el.addEventListener("click", fn); };
  on("feat-upgrade-btn", () => featOpen("pricing-modal-overlay"));
  ...
  on("feat-views-btn", () => { featOpen("views-modal-overlay"); featViewsRefresh(); });
  on("view-save-btn", featViewSave);
  on("feat-admin-btn", () => featOpen("admin-modal-overlay"));
