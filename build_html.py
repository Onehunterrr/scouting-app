...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .dash-bar-left { display: flex; align-items: baseline; gap: 10px; flex-wrap: wrap; }
  ...
  .wgt-tools {
    position: absolute; top: -10px; right: -6px; z-index: 20;
...
function initDashboard() {
  ...
  document.getElementById("dash-reset-btn").addEventListener("click", () => {
    ...
    dashSaveConfig(); dashRefreshAddMenu();
  });
